    ...
    return (
        <>
            <div id="introduction" className="mb-8">
                <p>
                    MyBL CMS is a complete React admin template with developer
                ...
                <p>
                    MyBL CMS offers several themes and layout options that allow
                    you to update the style of your application in no time, it
                    also supports dark theme & multiple locales including RTL
                    languages.
                </p>
                <p>
                    MyBL CMS has built-in working functionality pages, routing
            ...
            <div id="coreLibrary">
                ...
                <p>
                    Here is a list of some core libraries that we use in MyBL CMS:
                </p>
                <ul>
                    <li>
                        <a
